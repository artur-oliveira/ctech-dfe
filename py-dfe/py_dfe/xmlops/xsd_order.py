"""XSD-defined child element order for fiscal document XML nodes.
...
# =============================================================================
# Private per-root/operation dicts — merged into XSD_ORDER at the bottom.
# =============================================================================

# ─────────────────────────────────────────────────────────────────────────────
# NF-e / NFC-e — Autorização  (mod 55 / mod 65)
# ─────────────────────────────────────────────────────────────────────────────
_ENVINFE: dict[str, list[str]] = {
...
# NF-e — Eventos
# ─────────────────────────────────────────────────────────────────────────────
_ENV_EVENTO_NFE: dict[str, list[str]] = {
...
#         distribuição DFe
# ─────────────────────────────────────────────────────────────────────────────
_SERVICOS_NFE: dict[str, list[str]] = {
...
# ─────────────────────────────────────────────────────────────────────────────
_SERVICOS_CTE: dict[str, list[str]] = {
...
# ─────────────────────────────────────────────────────────────────────────────
_SERVICOS_MDFE: dict[str, list[str]] = {
...
# ─────────────────────────────────────────────────────────────────────────────
_COMPARTILHADO: dict[str, list[str]] = {
...
# =============================================================================
# Public dict — merge of all private dicts above.
# Later dicts win on key collision (none expected, but explicit order gives
# precedence to more-specific sections).
# =============================================================================
XSD_ORDER: dict[str, list[str]] = {
    **_COMPARTILHADO,
    **_SERVICOS_NFE,
    **_ENV_EVENTO_NFE,
    **_ENVINFE,
