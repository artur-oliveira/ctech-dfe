...
export const DFE_USER_SCOPES = [
  ...
  'dfe:organization_toll_providers:read',
  'dfe:organization_toll_providers:write',
  'dfe:organization_cargo_units:read',
  'dfe:organization_cargo_units:write',
  'dfe:organization_import_declarations:read',
  'dfe:organization_import_declarations:write',
  'dfe:organization_insurance_policies:read',
  'dfe:organization_insurance_policies:write',
  'dfe:organization_product_lots:read',
  'dfe:organization_product_lots:write',
  'dfe:organization_fuel_pumps:read',
  'dfe:organization_fuel_pumps:write',
  'dfe:organization_payment_terminals:read',
  'dfe:organization_payment_terminals:write',
  ...
  'dfe:organization_operations:read',
  'dfe:organization_operations:write',
  'dfe:organization_vehicle_sets:read',
  'dfe:organization_vehicle_sets:write',
  'dfe:organization_tax_profiles:read',
  'dfe:organization_tax_profiles:write',
  'dfe:organization_payment_terms:read',
  'dfe:organization_payment_terms:write',
