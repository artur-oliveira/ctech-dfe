    ...
    <LegalPage title="Termos Adicionais — CTech DFe" updatedAt={UPDATED_AT}>
      ...
      <LegalSection heading="1. Sobre este documento">
        <p>
          ...
          <a href="https://accounts.aoctech.app/terms" className="underline underline-offset-4" target="_blank" rel="noreferrer">
            Termos de Uso
          </a>{' '}
          e a{' '}
          <a href="https://accounts.aoctech.app/privacy" className="underline underline-offset-4" target="_blank" rel="noreferrer">
